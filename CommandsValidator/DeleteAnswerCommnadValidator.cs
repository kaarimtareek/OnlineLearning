...
{
    public class DeleteAnswerCommnadValidator : AbstractValidator<DeleteAnswerCommand>
    {
        public DeleteAnswerCommnadValidator(IUserValidator userValidator,  IQuestionValidator questionValidator)
        {
